...
typedef void(^ck_async_transaction_completion_block_t)(TheodoliteAsyncTransaction *completedTransaction, BOOL canceled);
...
/**
 State is initially TheodoliteAsyncTransactionStateOpen.
 ...
 */
typedef NS_ENUM(NSUInteger, TheodoliteAsyncTransactionState) {
  TheodoliteAsyncTransactionStateOpen = 0,
  TheodoliteAsyncTransactionStateCommitted,
  TheodoliteAsyncTransactionStateCanceled,
};

/**
 @summary TheodoliteAsyncTransaction provides lightweight transaction semantics for asynchronous operations.

 @desc TheodoliteAsyncTransaction provides the following properties:
 ...
 */
@interface TheodoliteAsyncTransaction : NSObject
...
/**
 ...
 @see TheodoliteAsyncTransactionState
 */
@property (nonatomic, readonly) TheodoliteAsyncTransactionState state;
